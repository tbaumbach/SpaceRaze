<!-- Start red_box.jsp fragment -->

	<%-- Uses two variables: errorType and errorMessage --%>

 		<table style="width:250; border-collapse: collapse; border-spacing: 0;border-width: 0">
 		<tr>
 			<td class='MenuRedBorder' rowspan='10'><img src='/images/space.gif' width='1' height='1'></td><td class='MenuRedBorder' colspan='3'><img src='/images/space.gif' width='1' height='1'></td><td class='MenuRedBorder' rowspan='10'><img src='/images/space.gif' width='1' height='1'></td>
 		</tr>
 		<tr>
 		...
 		<tr>
 			<td colspan='3' class='MenuRedBorderLineMiddle' width='100%' class='useText3'><IMG height='1' src='spaceblack.gif' width='1'></td>
		</tr>
		<tr>
		...
		<!--
		<tr class='TRMainREDRED'>
			<td colspan='3' align=right class='MenuRedMain' onMouseOver=this.style.backgroundColor='#8f1414'; onMouseOut=this.style.backgroundColor=''; width='100%' class='useText3'><a href='#' class='MenuRedMain'>Close</a>&nbsp;&nbsp;</td>
		</tr>
		-->
		<tr class='TRMainREDRED'>
			<td colspan='3' class='MenuRedMain' width='100%' align='right' class='useText3'></td>
		</tr>
		<tr class='TRMainREDRED'>
			<td class='MenuRedMain' colspan='3'><img src='/images/space.gif' width='4' height='4'></td>
		</tr>
		<tr>
			<td class='MenuRedBorder' colspan='5'><img src='/images/space.gif' width='1' height='1'></td>
		</tr>
		</table>

<!-- End red_box.jsp fragment -->
