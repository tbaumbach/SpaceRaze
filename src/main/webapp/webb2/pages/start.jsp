...
<div style="left: 132px;width: 450px;position: absolute;top: 90px;">
		...
		<div class="SolidText">
		 <b>Important fixes:</b><br>
			* INGAME Mail, det fungerar att skicka mail som kommer fram direkt, s� man kan prata diplomati med sina medspelare innan varje drag<br>
			* M�jligheten att ha fler �n en startplanet.<br>
			* Man kan s�tta ett parti turnbaserat<br>
			* Fixxar av klient layout<br>
			* Fixxar av Webb Layout<br><br>
			
			<a href="http://www.spaceraze.com/webb2/Master.jsp?action=guides_list"> * Guides: L�s nya guides, Klicka h�r</a><br>		
			 <a href="http://www.spaceraze.com/webb2/Master.jsp?action=gameworlds_list">* Gameworlds: L�r dig nya spelv�rldar, Klicka h�r</a><br>		
		</div>
		</div>
