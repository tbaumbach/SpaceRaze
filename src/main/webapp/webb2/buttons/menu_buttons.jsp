...
%>
<div style="left: 20px;width: 100px;position: absolute;top: 115px;">
	...
	<!-- Fungerar inte och ingen bra ide att ha p� serven.
	...
	<!-- Kan inte hitta dessa sidor, inte utvecklade eller ligger de p� n�gon server, leta lite i gamla tomtcats
