...
public class SpaceRazeClient extends JApplet{
...
//  private ImageIcon factionEmblem;
  ...
  public SpaceRazeClient(){
	  // is called by browser, do nothing
  }

  public SpaceRazeClient(Map<String,String> applicationParams, NotifierFrame notifierFrame){
  ...
  public static void main(String [] args) {
	  ...
	  //TODO De parmeterna ska komma från serven, frågan är hur det bäst görs.
	  /*
	   * <APPLET codebase="." ARCHIVE="spaceraze.jar" CODE = "sr.client.SpaceRazeApplet.class" WIDTH = 1200 HEIGHT = 710>
		    ...
		    <PARAM NAME = "username" VALUE="tobbe">
		    <PARAM NAME = "userpassword" VALUE="tobbe">
		    <PARAM NAME = "returnto" VALUE="games_list">
	  ...
	  parameters.put("HEIGHT", "710");
	  parameters.put("scriptable", "false");
	  parameters.put("port", "1");
	  parameters.put("username", "tobbe");
	  parameters.put("userpassword", "tobbe");
	  parameters.put("returnto", "games_list");
	  parameters.put("returnto_delete", "null");
	  parameters.put("autouser", "true");
	  
	  
	  SpaceRazeClient spaceRazeClient = new SpaceRazeClient(parameters, null);
	  spaceRazeClient.init();
  }
...
//  }
//
  //TODO Den här metoden ska läsa in parametrar via jnlp fil eller inmatning. Är en Applet method.
