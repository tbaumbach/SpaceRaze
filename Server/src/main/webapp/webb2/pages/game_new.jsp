...
<td>Map:&nbsp;&nbsp;&nbsp;</td>
<td>
	<select  name="mapname" style="width:300px;" class="InputText">
...
<tr>
<td>Password:&nbsp;&nbsp;&nbsp;</td>
<td><input type="text" class="InputText" style="width:300px;" name="game_password" value="" MAXLENGTH=20>&nbsp;&nbsp;(empty = open for all)</td>
</tr>
<tr>
<td>Ranked game:&nbsp;&nbsp;&nbsp;</td>
...
<td><input type="checkbox" checked name="autobalance" value="yes"></td>
</tr>
<tr>
<td>Send e-mail to all players:&nbsp;&nbsp;&nbsp;</td>
<td><input class="InputText" type="checkbox"  name="emailplayers" value="yes"></td>
</tr>
<tr>
